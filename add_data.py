...
class trainToplevel:
    def __init__(self, top=None):
        ...
        _compcolor = '#c5c8c9' # X11 color: 'blue6'
        _ana1color = '#c5c8c9' # X11 color: 'blue6' 
        ...
        top.geometry("1000x768+150+0")
        top.title("Tambah Data")
        top.configure(background="#c5c8c9")
        top.configure(highlightbackground="#81a3a6")
        top.configure(highlightcolor="black")

        self.Label1_6 = tk.Label(top)
        self.Label1_6.place(relx=0.40, rely=0.014, height=21, width=250)
        ...
        self.Label1_6.configure(text='''TAMBAH DATA LATIH''')
        ...
        self.filebrowseButton1.place(relx=0.29, rely=0.09, height=24, width=100)
        ...
        self.Label1_15 = tk.Label(top)
        self.Label1_15.place(relx=0.63, rely=0.09, height=21, width=70)
        self.Label1_15.configure(activebackground="#f9f9f9")
        self.Label1_15.configure(activeforeground="black")
        self.Label1_15.configure(background="#c5c8c9")
        self.Label1_15.configure(disabledforeground="#a3a3a3")
        self.Label1_15.configure(font=font9)
        self.Label1_15.configure(foreground="#000000")
        self.Label1_15.configure(highlightbackground="#81a3a6")
        self.Label1_15.configure(highlightcolor="black")
        self.Label1_15.configure(text='''Kategori''')

        self.tkvar = tk.StringVar(root)
        choices = {'group a','group b','normal'}
        self.tkvar.set('group a') # set the default option
        self.kategoriDropdown = tk.OptionMenu(top, self.tkvar, *choices)
        self.kategoriDropdown.place(relx=0.63, rely=0.13, height=24, width=87)
        self.kategoriDropdown.configure(activebackground="#ececec")
        self.kategoriDropdown.configure(activeforeground="#000000")
        self.kategoriDropdown.configure(background="#81a3a6")
        self.kategoriDropdown.configure(disabledforeground="#a3a3a3")
        self.kategoriDropdown.configure(foreground="#000000")
        self.kategoriDropdown.configure(highlightbackground="#81a3a6")
        self.kategoriDropdown.configure(highlightcolor="black")
        self.kategoriDropdown.configure(pady="0")

        self.ketText = tk.Text(top)
        self.ketText.place(relx=0.75, rely=0.13, height=50
                , width=200)
        self.ketText.configure(background="white")
        self.ketText.configure(font=font14)
        self.ketText.configure(foreground="black")
        self.ketText.configure(highlightbackground="#81a3a6")
        self.ketText.configure(highlightcolor="black")
        self.ketText.configure(insertbackground="black")
        self.ketText.configure(selectbackground="#c4c4c4")
        self.ketText.configure(selectforeground="black")
        self.ketText.configure(width=224)
        self.ketText.configure(wrap='word')
        self.ketText.configure(state='disabled')
        ...
        self.addButton = tk.Button(top,command=self.add)
        self.addButton.place(relx=0.14, rely=0.19, height=24, width=87)
        ...
        self.addButton.configure(highlightbackground="#81a3a6")
        self.addButton.configure(highlightcolor="black")
        self.addButton.configure(pady="0")
        self.addButton.configure(text='''Tambah Data''')
        ...
        self.asliCanvas.place(relx=0.07, rely=0.29, relheight=0.18
                , relwidth=0.16)
        ...
        self.grayCanvas.place(relx=0.42, rely=0.29, relheight=0.18
                , relwidth=0.16)
        ...
        self.closeCanvas.place(relx=0.77, rely=0.29, relheight=0.18
                , relwidth=0.16)
        ...
        self.threshCanvas.place(relx=0.07, rely=0.56, relheight=0.18
                , relwidth=0.16)
        ...
        self.erodeCanvas.place(relx=0.42, rely=0.56, relheight=0.18
                , relwidth=0.16)
        ...
        self.invCanvas.place(relx=0.77, rely=0.56, relheight=0.18
                , relwidth=0.16)
        ...
        self.Label1_7 = tk.Label(top)
        self.Label1_7.place(relx=0.4, rely=0.77, height=21, width=200)
        self.Label1_7.configure(activebackground="#f9f9f9")
        self.Label1_7.configure(activeforeground="black")
        self.Label1_7.configure(background="#c5c8c9")
        self.Label1_7.configure(disabledforeground="#a3a3a3")
        ...
        self.edgeCanvas.place(relx=0.42, rely=0.81, relheight=0.18
                , relwidth=0.16)
    ...
    def proses(self):
        ...
        if 'folder' in file:
            self.ketText.configure(state='normal')
            self.ketText.delete("1.0","end-1c")
            self.ketText.insert(tk.INSERT,'maaf anda tidak bisa menampilkan gambar karena memasukkan folder, bukan file')
            self.ketText.configure(state='disabled')
        else:
            ...
            new.place_image(imgs.img,self.asliCanvas,0.07, 0.29, 0.18, 0.16)
            new.place_image(imgs.imgray,self.grayCanvas,0.42, 0.29, 0.18, 0.16)
            new.place_image(imgs.immorph,self.closeCanvas,0.77, 0.29, 0.18, 0.16)
            new.place_image(imgs.imbin,self.threshCanvas,0.07, 0.56, 0.18, 0.16)
            new.place_image(imgs.imero,self.erodeCanvas,0.42, 0.56, 0.18, 0.16)
            new.place_image(imgs.iminv,self.invCanvas,0.77, 0.56, 0.18, 0.16)
            new.place_image(imgs.imedge,self.edgeCanvas,0.42, 0.81, 0.18, 0.16)
    ...
    def add(self):
        ...
        th2 = int(self.thres3Text.get('1.0','end-1c'))
        if 'folder' in file:
            folder = re.sub('folder:','',file)
            files = b2.get_1set_files(folder)
            dt = b2.open_images(files,thresh,nkernel,th1,th2)
            y = b2.get_label(files)
            dt2 = pd.DataFrame(dt)
            dt2['label'] = y
        else:
            kategori = self.tkvar.get()
            dt = b2.open_img(file,thresh,nkernel,th1,th2)
            dt = dt.reshape(1,len(dt))
            dt2 = pd.DataFrame(dt)
            dt2['label'] = kategori
        try:
            data = pd.read_csv(os.path.dirname(os.path.realpath(__file__))+"/db/"+'data_img.csv')
            if 'folder' in file:
                dt2 = dt2.values.tolist()
                for i in range(len(dt2)):
                    data.loc[len(data)+i] = dt2[i]
            else:
                data.loc[len(data)] = dt2.values.tolist()[0]
            data.to_csv(os.path.dirname(os.path.realpath(__file__))+"/db/"+'data_img.csv',index=False)
        except:
            dt2.to_csv(os.path.dirname(os.path.realpath(__file__))+"/db/"+'data_img.csv',index=False)
        self.ketText.configure(state='normal')
        self.ketText.delete("1.0","end-1c")
        self.ketText.insert(tk.INSERT,'data '+file+' telah ditambahkan')
        self.ketText.configure(state='disabled')
